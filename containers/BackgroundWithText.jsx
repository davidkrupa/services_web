...
const BackgroundWithText = () => {
  return (
    <div className="bg-[url('../assets/landscape.jpg')] bg-fixed bg-center flex justify-start items-center w-full h-[500px]">
      <div className="w-full sm:w-1/2 m-4 sm:ml-8 p-10 rounded-xl bg-white">
