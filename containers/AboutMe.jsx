    ...
    >
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-between items-center w-full gap-10  px-2 sm:px-6">
        <div className="w-5/6 sm:w-1/2">
          <h3
            data-test="about-me-name"
            className="text-3xl text-gray-800 font-semibold mb-8 pl-2 border-l-4 border-orange-400"
          >
            Full Name
          </h3>
          <p data-test="about-me-description">
        ...
        <div data-test="about-me-image" className="w-full sm:w-1/2">
          <Image
            src={heroImage}
            width={400}
            height={400}
